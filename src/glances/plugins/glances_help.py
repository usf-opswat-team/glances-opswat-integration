    ...
    def generate_view_data(self):
        ...
        self.view_data.update(
            [
                ...
                ('misc_opswat_scan_single_process', msg_col.format('o', 'OPSWAT MetaDefender Cloud single process scan')),
                ('misc_opswat_scan_all_processes', msg_col.format('O', 'OPSWAT MetaDefender Cloud all processes scan')),
